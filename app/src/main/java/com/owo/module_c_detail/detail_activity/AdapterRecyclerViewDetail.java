 ...
 * @created 2017/5/11
 */
public class AdapterRecyclerViewDetail extends RecyclerView.Adapter<Holder> {
    ...
    public AdapterRecyclerViewDetail(Context context) {
        mContext = context;
        list = new ArrayList<>();
    }
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.gird_user_item, parent, false);
   ...
   public void addItems( ArrayList<HashMap<String, Object>> list) {
        this.list = list;
    }
}
