...
import com.owo.module_b_message.controller.ConversationListController;
import com.owo.module_b_message.controller.MenuItemController;
import com.owo.module_b_message.view.ConversationListView;
import com.owo.module_b_message.view.MenuItemView;
...
public class FragMessage extends BaseFragment {
    ...
    private static String TAG = FragMessage.class.getSimpleName();
...
//                (ViewGroup) getActivity().findViewById(R.id.main_view), false);
        ...
        mRootView = layoutInflater.inflate(R.layout.fragment_conv_list,
                (ViewGroup) getActivity().findViewById(R.id.mainLayout), false);
        ...
        //JMessageClient.createSingleTextMessage("yup_001", "4d454221295c35af705cc26e", "Hello~ 我是机器人小y，欢迎来到yup！~");
