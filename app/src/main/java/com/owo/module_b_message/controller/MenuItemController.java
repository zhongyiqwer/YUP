...
public class MenuItemController implements View.OnClickListener {
    ...
    public MenuItemController(MenuItemView view, FragMessage context,
                    ...
                    public void onClick(View view) {
                        switch (view.getId()) {
                            ...
                            case R.id.jmui_commit_btn:
                                ...
                                ArrayList<HashMap<String, Object>> userList = searchUserByName(username);
                                String targetId ="";
                                if (userList.size()>0){
                                    targetId = "yup_"+userList.get(0).get("id").toString();
                                }else {
                                    targetId="yup_000";
                                }
