package com.owo.module_b_message.view;
...
public class ConversationListView {
    ...
    private LinearLayout mLoadingIv;
	...
	public void initModule() {
        ...
        mLoadingIv = (LinearLayout) mLoadingHeader.findViewById(R.id.loading);
		//mLoadingIv.setBackgroundResource(R.drawable.jmui_loading);
...
//        AnimationDrawable drawable = (AnimationDrawable) mLoadingIv.getBackground();
//        drawable.start();
//        mLoadingIv.setVisibility(View.VISIBLE);
	}
